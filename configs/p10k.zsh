# Generated by Powerlevel10k configuration wizard on 2025-04-02 at 19:20 EDT.
...
# Suppress warnings about console output during zsh initialization
...
() {
  ...
  # Use the same color as the regular prompt for transient prompt for consistency
  function p10k-on-post-prompt() { p10k display '1'=show '2/right/*'=hide }
  function p10k-on-pre-prompt() { p10k display '1'=show '2/right/*'=hide }
  ...
  typeset -g POWERLEVEL9K_ASDF_PYTHON_BACKGROUND=6
  ...
  # Only show the basename of the virtual environment
